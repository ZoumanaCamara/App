 ...
 */
final class Version20231027122120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profile (id INT AUTO_INCREMENT NOT NULL, reseau_social VARCHAR(50) DEFAULT NULL, profile VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
